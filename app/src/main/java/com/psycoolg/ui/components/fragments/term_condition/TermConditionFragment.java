...
import com.psycoolg.databinding.FragmentTermConditionBinding;
...
public class TermConditionFragment extends BaseFragment {
    private FragmentTermConditionBinding binding;
    private TermConditionViewModel homeViewModel;
    private View.OnClickListener onClickListener = null;
    private HomeActivity homeActivity;

    @Override
    protected ViewDataBinding setBinding(LayoutInflater inflater, ViewGroup container) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_term_condition, container, false);
    ...
    public void onResume() {
        ...
        binding.appBar.tvTitle.setText("Terms & Conditions");
